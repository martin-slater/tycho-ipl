...
call edge_sobel(src = clean, dst = edge3, kernel_size = 3, invert = true);
call edge_sobel(src = clean, dst = edge5, kernel_size = 5, invert = true);
call edge_sobel(src = clean, dst = edge7, kernel_size = 7, invert = true);
call edge_sobel(src = clean, dst = edge9, kernel_size = 9, invert = true);
