...
//MS: Disable some warnings under VC
#ifdef _MSC_VER
#pragma warning(disable: 4244) // conversion from double to float
#pragma warning(disable: 927) // formal parameter 1 different from declaration
#pragma warning(disable: 4028 4305) // truncation from 'double' to 'float'
